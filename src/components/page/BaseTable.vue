<template>
    <div>
        ...
        <div class="container">
            ...
            >
                <!--注意，数据在../../public下的table.json
                commit 作为注释，请不要在此中引用-->
                <!--
                //删除标签
                ...
                <!--职位标签-->
                <el-table-column prop="work" label="职位" width="75px"></el-table-column>
                <!--学院-->
                ...
                <!--学号/工号-->
                <el-table-column prop="schoolID" label="学号/工号"></el-table-column>
                <!--注册时间-->
